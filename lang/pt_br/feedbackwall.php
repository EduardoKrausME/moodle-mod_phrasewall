...
$string['allowedit_help'] = 'Quando habilitado, o estudante pode substituir a frase já enviada. A atividade mantém sempre apenas uma frase por estudante.';
$string['anonymity'] = 'Como a autoria será exibida';
$string['anonymity_help'] = 'Escolha se o nome do estudante aparece no mural. Professores com permissão para acessar o relatório continuam podendo identificar os autores para moderação e auditoria.';
$string['anonymous'] = 'Anônimo no mural';
$string['anonymousauthor'] = 'Anônimo';
$string['anonymousnotice'] = 'Os nomes estão ocultos neste mural.';
$string['cannotedit'] = 'Sua frase já foi publicada e a edição está desabilitada nesta atividade.';
$string['completionsubmit'] = 'O estudante deve publicar uma frase';
$string['created'] = 'Criada em';
$string['delete'] = 'Excluir resposta';
$string['deleteconfirm'] = 'Excluir esta resposta? O estudante poderá enviar uma nova frase depois.';
$string['errorempty'] = 'Escreva uma frase antes de enviar.';
...
$string['modulename'] = 'Mural de uma frase';
$string['modulenameplural'] = 'Murais de uma frase';
$string['name'] = 'Nome do mural';
$string['named'] = 'Mostrar o nome do estudante';
$string['noresponses'] = 'O mural ainda está vazio';
$string['noresponsesdescription'] = 'As primeiras frases aparecerão aqui assim que os estudantes publicarem.';
...
$string['responsescount'] = 'Respostas: {$a}';
$string['settingsheader'] = 'Configurações do mural';
$string['submitphrase'] = 'Publicar no mural';
$string['updatephrase'] = 'Atualizar minha frase';
$string['yourphrase'] = 'Sua frase';
$string['yourphrase_help'] = 'Escreva uma única frase curta para aparecer no mural.';
