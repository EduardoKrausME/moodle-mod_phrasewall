...
$string['allowedit_help'] = 'When enabled, a student can replace their existing sentence. The activity always keeps only one sentence per student.';
$string['anonymity'] = 'How authors are displayed';
$string['anonymity_help'] = 'Choose whether student names appear on the public wall. Teachers with report permission can still identify authors for moderation and auditing.';
$string['anonymous'] = 'Anonymous on the wall';
$string['anonymousauthor'] = 'Anonymous';
$string['anonymousnotice'] = 'Names are hidden on this wall.';
$string['cannotedit'] = 'Your sentence has already been posted and editing is disabled for this activity.';
$string['completionsubmit'] = 'Student must post a sentence';
$string['created'] = 'Created';
$string['delete'] = 'Delete response';
$string['deleteconfirm'] = 'Delete this student response? The student will be able to submit again.';
$string['errorempty'] = 'Write a sentence before submitting.';
...
$string['modulename'] = 'Feedback wall';
$string['modulenameplural'] = 'Feedback walls';
$string['name'] = 'Wall name';
$string['named'] = 'Show student names';
$string['noresponses'] = 'The wall is still empty';
$string['noresponsesdescription'] = 'The first sentences will appear here as soon as students post them.';
...
$string['responsescount'] = 'Responses: {$a}';
$string['settingsheader'] = 'Wall settings';
$string['submitphrase'] = 'Post to the wall';
$string['updatephrase'] = 'Update my sentence';
$string['yourphrase'] = 'Your sentence';
$string['yourphrase_help'] = 'Write one short sentence for the wall.';
